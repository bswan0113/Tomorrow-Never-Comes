...
namespace Core.Data.Interface
{
    ...
    public interface IPlayerStatsRepository
    {
        ...
        UniTask<PlayerStatsData> LoadPlayerStatsAsync(int saveSlotId);
        ...
        UniTask SavePlayerStatsAsync(PlayerStatsData data, ITransaction transaction); // 트랜잭션 인자 추가

        /// <summary>
        /// 지정된 세이브 슬롯 ID에 해당하는 PlayerStatsData를 비동기적으로 삭제합니다.
        /// </summary>
        /// <param name="saveSlotId">삭제할 세이브 슬롯 ID.</param>
        UniTask DeletePlayerStatsAsync(int saveSlotId);
        ...
        UniTask<bool> HasPlayerStatsDataAsync(int saveSlotId);
    }
