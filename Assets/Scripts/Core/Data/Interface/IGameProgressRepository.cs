...
namespace Core.Data.Interface
{
    ...
    public interface IGameProgressRepository
    {
        ...
        UniTask<GameProgressData> LoadGameProgressAsync(int saveSlotId);
        ...
        UniTask SaveGameProgressAsync(GameProgressData data, ITransaction transaction); // 트랜잭션 인자 추가

        /// <summary>
        /// 지정된 세이브 슬롯 ID에 해당하는 GameProgressData를 비동기적으로 삭제합니다.
        /// </summary>
        /// <param name="saveSlotId">삭제할 세이브 슬롯 ID.</param>
        UniTask DeleteGameProgressAsync(int saveSlotId);
        ...
        UniTask<bool> HasGameProgressDataAsync(int saveSlotId);
    }
}